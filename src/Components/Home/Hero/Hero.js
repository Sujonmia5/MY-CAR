        ...
        <section>
            <div className=''>
                <div className="container flex flex-col items-center px-4 py-16 pb-24 mx-auto text-center lg:pb-56 md:py-32 md:px-10 lg:px-32 text-gray-900">
                    ...
                    <p className="mt-6 text-lg xl:max-w-3xl text-gray-900">Sign up for free and open an account to sell your products! It usually takes 2 minutes to post an add.</p>
                    <p className="mb-8 text-lg sm:mb-12 xl:max-w-3xl text-gray-900">It has the largest collection of products in all of Bangladesh, thousands of products in 4 categories. And you can buy products easily.</p>
