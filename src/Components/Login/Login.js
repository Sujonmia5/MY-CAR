...
const Login = () => {
    ...
    return (
        <>
            {error && <p className='text-red-600 text-center mt-8 mb-0'>{error}</p>}
            <div className="px-8 pb-8 pt-4 lg:w-1/3 mx-auto">
                <div className="bg-gray-100 rounded-b-lg py-12 px-4 lg:px-12">
                    <p className="text-center text-lg font-bold text-gray-900">Log in with</p>
                    <form onSubmit={handleSubmit(LoginData)} className="mt-6">
                        <div className="relative">
                            <input {...register('email', { required: 'Email Required' })} className="appearance-none border pl-12 border-gray-100 shadow-sm focus:shadow-md focus:placeholder-gray-600  transition  rounded-md w-full py-3 text-gray-600 leading-tight focus:outline-none focus:ring-gray-600 focus:shadow-outline" id="username" type="email" placeholder="Email" />
                        ...
                        <div className="relative mt-3">
                            ...
                            })} className="appearance-none border pl-12 border-gray-100 shadow-sm focus:shadow-md focus:placeholder-gray-600  transition  rounded-md w-full py-3 text-gray-600 leading-tight focus:outline-none focus:ring-gray-600 focus:shadow-outline" id="password" type="password" placeholder="Password" />
                            <div className="absolute left-0 inset-y-0 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 ml-3 text-gray-400 p-1" viewBox="0 0 20 20" fill="currentColor"            >
                        ...
                        <div className="flex items-center justify-center mt-8">
                            <button className="text-white py-2 px-4 uppercase rounded bg-primary hover:bg-red-500 shadow hover:shadow-lg font-medium transition transform hover:-translate-y-0.5">Sign in</button>
                        </div>
                    </form>
                    ...
                    <p className='text-gray-900 mt-5 w-full'>Don't have an account? <Link to='/register' className='text-blue-600 hover:underline'>Create account</Link></p>
                </div>
            </div>
        </>
    );
