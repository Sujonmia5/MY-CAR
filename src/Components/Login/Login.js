...
const Login = () => {
    return (
        <div class="p-8 lg:w-1/3 mx-auto">
            <div class="bg-gray-100 rounded-b-lg py-12 px-4 lg:px-12">
                <p class="text-center text-lg font-bold text-gray-900">Log in with</p>
                <form class="mt-6">
                    <div class="relative">
                    ...
                    <div class="flex items-center justify-center mt-8">
                        <button class="text-white py-2 px-4 uppercase rounded bg-primary hover:bg-red-500 shadow hover:shadow-lg font-medium transition transform hover:-translate-y-0.5">Sign in</button>
                    </div>
                </form>

                <div class=" rounded-t-lg px-8 pt-8">
                    <p class="text-center text-sm text-gray-800 font-light">Or sign in with credentials</p>
                    <div>
