...
export const Navbar = () => {
    ...
    const menu = <>
        ...
        <li><Link to="/category" aria-label="Category" title="Category" className="hover:text-primary font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">Category</Link></li>
    ...
    return (
        <div class="px-4 shadow-xl rounded py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
            <div class="relative flex items-center justify-between">
                <a
                    href="/"
                    aria-label="Company"
                    title="Company"
                    class="inline-flex items-center hover:bg-gray-300 p-2 rounded-md duration-1000"
                >
